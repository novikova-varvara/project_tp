...
4. Полезные паттерны и хинты.

Builder - для последовательного создания клиента

Command - например, для транзакций

Facade - интерфейс для взаимодействия клиент-банк

6. Для запуска вам нужно использовать интерпретатор python.
