...
2. Счета бывают трёх видов: Дебетовый счет, Депозит и Кредитный счет. Каждый счет принадлежит ĸаĸому-то ĸлиенту. 
...
4. Полезные паттерны и хинты: builder - для последовательного создания клиента, command - например, для транзакций, facade - интерфейс для взаимодействия клиент-банк.

5. Для запуска вам нужно использовать интерпретатор python.
